...
client = pymongo.MongoClient("mongodb+srv://mangodb:goal15lpa@cluster0.ix39k.mongodb.net/?retryWrites=true&w=majority")
db = client.test

data = {
    "name" : "prasad",
    "surname": "veerothu",
    "current filed" : "informatica",
    "aspireated field " : ["Data science","data engineering"]
}

database = client["Mywork"]
collection = database["Pramon"]
...
record = collection.find()
data = collection.find({"data" : {'batteryVoltageStableTime':'1'}})
for i in data:
    print(i)
